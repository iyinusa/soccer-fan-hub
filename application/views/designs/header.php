...
<head>
    ...
    <?php if($page_active=='moot'){ ?>
    <meta property="fb:app_id" content="335966623275742" />
	<meta property="og:site_name" content="SoccerFanHub" />
    <meta name="author" itemprop="author" content="<?php if(!empty($fan_display_name)){echo $fan_display_name;} else {echo 'SoccerFanHub';} ?>" />
	<meta property="article:author" content="<?php if(!empty($fan_nicename)){echo base_url('fan/'.$fan_nicename);} else {echo 'SFH';} ?>" />
    <meta name="original-source" content="<?php if(!empty($pg_link)){echo base_url('moot/'.$pg_link);} else {echo base_url('moots/');} ?>" />
	<link rel="canonical" href="<?php if(!empty($pg_link)){echo base_url('moot/'.$pg_link);} else {echo base_url('moots/');} ?>" />
    <meta property="og:title" content="<?php if(!empty($fan_display_name)){echo $fan_display_name.' | SoccerFanHub';} else {echo 'SoccerFanHub';} ?>" />
	<meta property="og:description" itemprop="description" content="<?php if(!empty($moot)){echo $moot;} else {echo 'SoccerFanHub';} ?>" />
	<meta property="og:url" itemprop="url" content="<?php if(!empty($pg_link)){echo base_url('moot/'.$pg_link);} else {echo base_url('moots/');} ?>" />
	<meta itemprop="image" property="og:image" content="<?php if(!empty($fan_pics_small)){echo base_url($fan_pics_small);} else {echo base_url('img/logo.png');} ?>" />
    <?php } ?>
