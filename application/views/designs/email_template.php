...
<body>
	<div style="width:95%; background-color:#eee; margin:auto; padding:10px;">
        <div style="background-color:#fff; border:1px solid #999; margin:auto;">
            <div class="e_header">
                <a href="<?php base_url(); ?>"><img alt="SFH " src="<?php echo base_url(); ?>img/logo.png" style="float:left; margin-right:10px;" /> <br /><h1>SoccerFanHub</h1></a>
            </div>
            ...
            <div class="e_footer">
                <strong>SoccerFanHub Team</strong><br />
                <small>
                	<i>info@soccerfanhub.com</i><br />
                    <i>http://soccerfanhub.com</i><br />
                </small>
            </div>
        </div>
    </div>
